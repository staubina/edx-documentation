...
This section introduces the core set of problem types that can be added to any
course with the problem component. It also describes options for editing
problems and the settings that you define.

.. contents::
 :local:
 :depth: 1

For more information about problems and the other exercises and tools that you
can add to your course, see :ref:`Create Exercises`.

****************
Adding a Problem
****************

To add interactive exercises to your course, on a :ref:`unit<The Unit
Workflow>` page you select **Problem**. After you select **Problem**, you
choose the type of problem you want to add from a list of **Common Problem
Types** or **Advanced** problem types.
...
assignment type that is defined at the subsection level. As a result, all of
...
example problem of that type to the unit. You select **Edit** to open the
example problem in an editor.
...
* For advanced problem types (with the exception of peer assessment), the
  :ref:`advanced editor<Advanced Editor>` opens. In this editor you use OLX
  (open learning XML) tags, elements, and attributes to identify the
  elements of the problem.

  For peer assessment problem types, you define the problem elements and
  options through a graphical user interface. For more information, see
  :ref:`PA Create an ORA Assignment`.

You can switch from the simple editor to the advanced editor at any time:
select **Advanced Editor** from the simple editor's toolbar. However, after
...
When you edit one of these common problem types, the simple editor opens with
an example problem that you can use as a template for adding markdown
formatting.
...
====================================
Adding Markdown in the Simple Editor
====================================
...
#. **Text Input**: Identifies the correct answer for a text
   input problem by adding an equals sign (``=``) before it on the same line.

#. **Numerical Input**: Identifies the correct answer for a
...
#. **Explanation**: Identifies the explanation for the
   ...
   learners with the :ref:`Show Answer` setting.
...
#. **Accessible Label**: Identifies the prompt, or question, that learners need
   ...
   <<``) around the text. For example, ``>>Is this the question?<<``.
...
Insights. Unique, descriptive display names help you and your learners identify
...
problem-specific setting. Initially, the value for course-wide setting is null,
meaning that learners can try to answer problems correctly an unlimited number
of times. You can change the course-wide default by selecting **Settings** and
...
component and then add all of the assignment's questions to that one component.
All of the questions can have the same problem type, such as a series of
multiple choice questions, or you can include questions that use different
...
When you add multiple question to a single problem component, the settings that
you define, including the display name and whether to show the **Reset**
...
To include multiple questions in a single problem component, you edit the
problem to replace the example with your first question and its answer or
answer choices. Then, you add the next question and answer or answers below the
first one. Be sure to identify every question or prompt with the appropriate
markdown characters (``>> <<``) or OLX markup and include all of the other
required elements for the problem type.
...
.. note:: Problem randomization is different from the **Randomization** setting
   that you define in Studio. Problem randomization offers different problems
