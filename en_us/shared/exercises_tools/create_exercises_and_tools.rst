...
also have the option to expand the initial set of core problem types by
...
***************************************
Adding More Exercises and Tools
***************************************

Exercises and tools is a general way to refer to the robust variety of content
that you can integrate into an online course. Software developers use the
XBlock component architecture to contribute new exercises and tools to the Open
edX platform and provide new and varied options for reaching learners.
...
.. list-table::
   ...
   * - :ref:`Open Response Assessments 2`
     - Learners submit responses and receive feedback from other course
       participants. Open response assessments include self assessment and peer
       assessment.
     - Full support
...
.. list-table::
   ...
   * - :ref:`Image Mapped Input`
     ...
     - Provisional support
   * - :ref:`Zooming Image`
     - Learners are shown a section of an image in detail. You specify the
       image section.
     - Full support
...
.. list-table::
   ...
   * - :ref:`Multiple Choice and Numerical Input`
     - Learners both choose one answer from a set of possible options, and are
       prompted to provide more specific information, if necessary.
...
.. list-table::
   ...
   * - :ref:`Periodic Table`
     - An interactive periodic table of the elements shows detailed information
       about each element as learners select each element.
     - No support
   * - :ref:`Protein Builder`
